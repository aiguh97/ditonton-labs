...
import 'package:ditonton/data/repositories/tv_repository_implements.dart';
...
void init() {
  ...
  locator.registerLazySingleton<TVRepository>(
    () => TVRepositoryImpl(remoteDataSource: locator(), networkInfo: locator()),
  );
  ...
  locator.registerFactory(
    () => TVSeriesNotifier(getTVSeries: locator(), searchTVSeries: locator()),
  );
