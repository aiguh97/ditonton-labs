    ...
    return Scaffold(
      body: BlocListener<MovieDetailBloc, MovieDetailState>(
        listener: (context, state) {
          if (state is MovieDetailWatchlistUpdated) {
          ...
          builder: (context, state) {
            if (state is MovieDetailLoading) {
              return const Center(child: CircularProgressIndicator());
                ...
                state is MovieDetailWatchlistUpdated) {
              ...
              } else if (state is MovieDetailWatchlistUpdated) {
                movie = state.movie;
                recommendations = state.recommendations;
                isAddedToWatchlist = state.isAddedToWatchlist;
              }
                              ...
                              onPressed: () {
                                if (!isAddedWatchlist) {
                                  context.read<MovieDetailBloc>().add(
                                    AddMovieToWatchlistEvent(movie),
                                  );
                                } else {
                                  context.read<MovieDetailBloc>().add(
                                    RemoveMovieFromWatchlistEvent(movie),
                                  );
                                }
                              },
                              child: Row(
                                ...
                                if (state is MovieDetailLoading) {
                                  ...
                                  if (state is MovieDetailLoaded) {
                                    recoms = state.recommendations;
                                      ...
                                      is MovieDetailWatchlistUpdated) {
                                    recoms = state.recommendations;
                                  }
                                          ...
                                          child: InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl:
                                                    'https://image.tmdb.org/t/p/w500${mov.posterPath}',
                                                placeholder: (context, url) =>
                                                    const Center(
                                                      child:
